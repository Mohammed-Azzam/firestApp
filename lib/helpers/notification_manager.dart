...
class NotificationManager {
  ...
  Future<void> showCourseNotification(
      Post element, Map<String, dynamic>? inputData) async {
    ...
    final String largeIconPath = await nm.downloadAndSaveFile(
        ((element.featuredMedia ??
                    (Media(
                        sourceUrl:
                            'https://speedandsuccessphone.website/draft/old/wp-content/uploads/2021/04/site_logo-2.png')))
                .sourceUrl) ??
            'https://speedandsuccessphone.website/draft/old/wp-content/uploads/2021/04/site_logo-2.png',
    ...
    IOSNotificationDetails firstNotificationIosSpecifics =
    ...
    await flutterLocalNotificationsPlugin.show(
      element.id!,
      element.title!.rendered,
      'New lesson added in ${inputData!['categoryName']} Keep the hard work',
      firstNotificationPlatformSpecifics,
      payload: element.title!.rendered,
    );
  }
