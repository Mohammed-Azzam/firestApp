...
class ParamsCategoryList {
  ...
  Map<String, String> toMap() {
    return {
      ...
      'exclude': this.excludeCategoryIDs ==null?'':'${listToUrlString(this.excludeCategoryIDs!)}',
      'include': this.includeCategoryIDs ==null?'':'${listToUrlString(this.includeCategoryIDs!)}',
